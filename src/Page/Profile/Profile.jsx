...
const Profile = () => {
  ...
  return (
    <div>
      <div className="bg-[#32D2D7] w-full">
        {" "}
        <Navbar></Navbar>
      </div>

      <div className="flex selection:text-black selection:bg-white justify-center gap-14 flex-col lg:flex-row h-[100vh]   bg-[#32d2d7]">
        <div className=" w-full lg:w-[300px] min-h-[80vh] ">
          <div className="group before:hover:scale-95 before:hover:h-72  before:w-full lg:before:hover:w-80 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-['']  before:h-[14rem] before:rounded-t-2xl before:bg-gradient-to-bl from-[#030F1C] via-[#05E2C3] to-[#0B5653] before:absolute before:top-0 w-full lg:w-[19rem] h-[33rem] relative bg-[#0F0D21] flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
